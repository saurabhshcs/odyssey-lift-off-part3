...
var Modal = function (_a) {
  var _b = _a.as,
      as = _b === void 0 ? core.jsx("div", null) : _b,
      className = _a.className,
      _c = _a.containerAs,
      containerAs = _c === void 0 ? core.jsx("div", null) : _c,
      title = _a.title,
      description = _a.description,
      children = _a.children,
      _d = _a.verticalScrollMode,
      verticalScrollMode = _d === void 0 ? "modal" : _d,
      onClose = _a.onClose,
      size = _a.size,
      bottomLeftText = _a.bottomLeftText,
      primaryAction = _a.primaryAction,
      secondaryAction = _a.secondaryAction;
  var backdropMouseDownTargetRef = React.useRef(null);
  ...
  var type = as.props.__EMOTION_TYPE_PLEASE_DO_NOT_USE__ || as.type;
  ...
  } else if (typeof type === "string" && !framerMotion.motion[type] && ! /*#__PURE__*/React__default.isValidElement(as)) {
    throw new TypeError("Could not determine the type of `as` to clone that element using Framer. This is most likely because it's a ref forwarding component and we don't have any way of determining what type it will render to.");
  }
  /**
  ...
  var MotionComponent = React__default.useMemo(function () {
    return typeof type === "string" ? framerMotion.motion[type] : framerMotion.motion.custom(type);
  }, [type]);
  return core.jsx(core.ClassNames, null, function (_a) {
    var css = _a.css,
        cx = _a.cx;
    return /*#__PURE__*/React__default.cloneElement(containerAs, _tslib.__assign(_tslib.__assign({
    ...
    }), core.jsx(MotionComponent, _tslib.__assign({}, as.props, {
      ref: as.ref,
      animate: {
        opacity: 1,
        scale: 1
      ...
      }), className, as.props.className, // If the parent component is using emotion with the jsx pragma, we
      // have to get fancy and intercept the styles to use with the
      // `ClassNames` wrapper.
      as.props.css ? css(as.props.css.styles) : null)
    }), core.jsx("div", null, title && core.jsx("div", null, core.jsx("div", {
      css: _tslib.__assign({
        color: colors.colors.black.base,
        marginBottom: 10
      }, size === "small" ? _tslib.__assign(_tslib.__assign({}, base$1.large), {
        fontWeight: 600
      }) : base$1.xxlarge)
    }, title)), description && core.jsx("div", {
    ...
    }, children), (primaryAction || secondaryAction || bottomLeftText) && core.jsx("div", {
      css: {
        alignItems: "center",
        display: "flex",
    ...
    }, bottomLeftText && core.jsx("div", {
      css: {
        marginRight: "auto"
      }
    }, bottomLeftText), secondaryAction && core.jsx("div", {
      css: {
        marginRight: 12
      }
    }, secondaryAction), primaryAction && core.jsx("div", null, primaryAction))));
  });
};
