...
var SingletonComponent = require('./SingletonComponent-7ca6baa8.js');
...
SingletonComponent.styleInject(css);

var TippyStyles = function () {
  return /*#__PURE__*/React__default.createElement(SingletonComponent.SingletonComponent, {
    identity: "src/AbstractTooltip/abstractTooltip/TippyStyles.tsx"
  }, React__default.useMemo(function () {
    return /*#__PURE__*/React__default.createElement(core.Global, {
      styles: core.css({
        ".tippy-box": {
          "&[data-theme=space-kit]": _tslib.__assign(_tslib.__assign({}, base$1.small), {
            backgroundColor: colors.colors.black.base,
            opacity: 0.95,
...
var AbstractTooltip = function (_a) {
  var _b = _a.animation,
      animation = _b === void 0 ? "shift-away" : _b,
      children = _a.children,
      className = _a.className,
      fallbackPlacements = _a.fallbackPlacements,
      forceVisibleForTestingOnly = _a.forceVisibleForTestingOnly,
      _c = _a.padding,
      padding = _c === void 0 ? "normal" : _c,
      trigger = _a.trigger,
      hideOnClick = _a.hideOnClick,
      _d = _a.matchTriggerWidth,
      matchTriggerWidth$1 = _d === void 0 ? false : _d,
      _e = _a.popperOptions,
      popperOptions = _e === void 0 ? {} : _e,
      props = _tslib.__rest(_a, ["animation", "children", "className", "fallbackPlacements", "forceVisibleForTestingOnly", "padding", "trigger", "hideOnClick", "matchTriggerWidth", "popperOptions"]);
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TippyStyles, null), /*#__PURE__*/React__default.createElement(Tippy, _tslib.__assign({
    ...
    theme: "space-kit",
    popperOptions: _tslib.__assign(_tslib.__assign({}, popperOptions), {
      modifiers: _tslib.__spreadArrays([{
        name: "computeStyles",
        options: {
      ...
      }, _tslib.__assign(_tslib.__assign({}, matchTriggerWidth), {
        enabled: matchTriggerWidth$1
...
//# sourceMappingURL=index-b2f6dbb4.js.map
